...
dependencies {
  ...
  implementation("io.arrow-kt:arrow-core:1.1.3-alpha.8")
  implementation("io.arrow-kt:arrow-optics:1.1.3-alpha.8")
  implementation("org.jetbrains.kotlinx:kotlinx-coroutines-core:1.6.2")
  implementation("io.arrow-kt:arrow-fx-coroutines:1.1.3-alpha.8")
